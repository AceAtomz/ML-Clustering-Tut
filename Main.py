...
kM = kMeans(clusters, 6)
obj=0.0
for i in range(10):
    cluster1, cluster2, cluster3, cluster4, cluster5, cluster6 = kM.getNewClusters()
...
ax1.set_title('Sixth Iteration with k=6 Clusters  (OBJ = ' + str(obj) + ')')
